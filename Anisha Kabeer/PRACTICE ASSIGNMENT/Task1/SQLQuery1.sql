...
VALUES (1, '2024-09-21', 25000.50);

UPDATE Customers SET Email = 'new.email@example.com', Address = '456 New St' WHERE CustomerID = 1;

UPDATE Orders
SET TotalAmount = (SELECT SUM(Products.Price * OrderDetails.Quantity)FROM OrderDetails
...
VALUES ('Smartwatch', 'Wearable device with health features', 199.99);
